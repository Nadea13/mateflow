-- Remove branch_id and assigned_branch_id from store_codes and store_team_members
DO $$
BEGIN
    IF EXISTS (
...
-- Update generate_store_code RPC function (without branch parameter)
...
-- Update join_store_by_code RPC function (without branch parameter)
